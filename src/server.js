...
const { getSapCategoryType } = require('./controllers/index.controller');
const { getPse } = require('./controllers/index.controller');
const { getPseKey } = require('./controllers/index.controller');
const { getCert } = require('./controllers/index.controller');
const { getSingleCert } = require('./controllers/index.controller');
